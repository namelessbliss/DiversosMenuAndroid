package com.example.proyectoandroid.semana13;
...
import com.example.proyectoandroid.semana13.API.API;
import com.example.proyectoandroid.semana13.API.APIService.WeatherService;
...
public class Sem13Activity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sem13);
    ...
    private String getImageOfCity(City city) {
        switch (city.getName()) {
            case "Amazonas":
                return "https://i1.wp.com/viajandoporperu.com/wp-content/uploads/2019/02/loreto-yurimaguas-0.jpg?ssl=1";
            case "Ancash":
